...
export default function StudyPhrasesScreen({ navigation }) {
  ...
  const {
    ...
    finishSession,
    resetSession,
  } = useStudySession(CARD_TYPE.PHRASE, SESSION_SIZE);
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          <Ionicons name="chatbubbles-outline" size={64} color={COLORS.textPlaceholder} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.cardArea}>
        <FlashCard card={currentCard} cardType="phrase" onRatingPress={scoreCard} />
      </View>
      ...
      {showExitConfirm && (
        <View style={styles.modalOverlay}>
          <View style={styles.modal}>
            ...
            <Text style={styles.modalText}>Vas a perder el progreso de esta sesión.</Text>
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={[styles.modalButton, { backgroundColor: COLORS.sageCream }]}
                onPress={() => setShowExitConfirm(false)}
              >
                <Text style={[styles.modalButtonText, { color: COLORS.oliveInk }]}>Continuar</Text>
              </TouchableOpacity>
              <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: SPACING.base, paddingVertical: SPACING.sm, gap: SPACING.md },
  progressWrapper: { flex: 1 },
  counter: { fontFamily: FONT_FAMILY.semiBold, fontSize: 14, color: COLORS.textSecondary },
  cardArea: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  hint: { fontFamily: FONT_FAMILY.regular, fontSize: 13, color: COLORS.textPlaceholder, textAlign: 'center', marginBottom: SPACING.xl },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: SPACING.xxl, gap: SPACING.base },
  emptyTitle: { fontFamily: FONT_FAMILY.semiBold, fontSize: 18, color: COLORS.textSecondary, textAlign: 'center' },
  ...
  modalButton: { flex: 1, borderRadius: 6, paddingVertical: 12, alignItems: 'center' },
